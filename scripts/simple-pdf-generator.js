    ...
    <div class="container">
        ...
        <div class="print-instructions no-print">
            ...
            <div class="print-buttons">
                <button onclick="printToPDF()" class="print-btn">
                    📄 Als PDF drucken
                </button>
                <button onclick="window.print()" class="print-btn secondary">
                    🖨️ Drucken
                </button>
            </div>
            <p><strong>Automatischer PDF-Export:</strong></p>
            <ol>
                <li>Klicken Sie auf "Als PDF drucken"</li>
                <li>Das Druckdialog öffnet sich automatisch</li>
                <li>Wählen Sie "Als PDF speichern" als Ziel</li>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                console.log('📄 PDF-Export bereit! Drücken Sie Ctrl+P oder klicken Sie auf "Als PDF drucken"');
            });
        </script>
    </div>
</body>
