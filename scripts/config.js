...
const FWV_CONFIG = {
    ...
    kontakte: {
        ...
        aktuar: {
            name: "Stefan Müller", 
            email: "aktuar@fwv-raura.ch", // Aktualisiert zur persönlichen E-Mail
        ...
        webmaster: {
            name: "Stefan Müller",
            email: "aktuar@fwv-raura.ch", // Persönliche E-Mail für IT-Themen
    ...
    defaultOrganizers: {
        chilbi: {
            name: "Stefan Müller",
            email: "aktuar@fwv-raura.ch" // Persönliche E-Mail für Chilbi-Organisation
        },
        generalEvent: {
            name: "René Käslin", 
            email: "praesident@fwv-raura.ch"
